          ...
          <Navbar expand="lg" className={`navbar ${darkMode ? 'dark' : 'light'}`} style={{ backgroundColor: darkMode ? '#1a1a1d' : '#FFEFEF' }}>
            ...
            <Navbar.Collapse id="basic-navbar-nav">
              <Nav className="mr-auto">
                <Nav.Link href="#about" className="link">Introdction</Nav.Link>
                <Nav.Link href="#skills" className="link">Management</Nav.Link>
                <Nav.Link href="#experience" className="link">Players</Nav.Link>
